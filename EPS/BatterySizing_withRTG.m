...
%
%% INPUT
% PowerDefect_watt [1x1] Difference in power between what is requested by loads, and what is produced by RTGs at peak load times.
% PowerDefectDuration_hours [1x1] Time that PowerDefect_watt lasts
% Battery_data [struct] Structure containing battery data, generated by loading variable from Batt_Data folder
