...
% orbiter  -  structure:        
        ...
        % m_prop_att_science_cl  [m/s] - Propellant mass for attitude maneuvers when clamped configuration (science orbit)
        % m_prop_att_science_o   [m/s] - Propellant mass for attitude maneuvers when only orbiter (science orbit)
        % m_prop_att_dsm_cl      [m/s] - Propellant mass for attitude maneuvers when clamped configuration (deep space maneuver)
        % dry                    [kg]  - Dry mass
