...
% files = dir('C:\Users\26ele\Desktop\POLI 2\ASMAD\PROJECT\Matlab Codes\Kernels');

% for i=1:length(files)
%     if strcmp(files(i).name, 'LATs.bsp')
%         delete 'LATs.bsp'
%     end
% end

% cd('Kernels');
% system('pinpoint.exe -def LATs.def -pck pck00010_mod.tpc -spk LATs.bsp -fk LATs.tf');
% cspice_furnsh 'LATs.bsp';
% cspice_furnsh 'LATs.tf';
% 
% system('brief -t -c LATs.bsp');
% cd('..')
