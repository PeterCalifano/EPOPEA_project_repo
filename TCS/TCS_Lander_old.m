...
P_cold_land = 327.12 -20 + 9.43 * 2 - 30 ; % science mode power budget - power TTMTC + dissipated by TTMTC - POWER DEDICATED TO TCS (TO SIZE)
...
theta_3Sun = 15 * pi/180;
theta_4Sun = 75 * pi/180;
...
Q_ext_hot = [0;
        ...
        q_Sun * A_4h * alpha_ext * cos(theta_4Sun) ;
