...
dV_int = MAR_080 + MAR_010*1.0158e+3 + MAR_020*1.1e+3 + MAR_100 + MAR_090;   % [m/s] - Interplanetary + capture + moon toru and EOI
Isp_int = 321; 
...
m_prop_int1 = preliminary_prop_mass(MAR_010*dV_int_leg_nomar,m_dry_int,Isp_int) ;
m_int = m_prop_int1 + m_dry_int ;
dt_int = m_prop_int1 / mdot_bip ;

dV_Sat_nomar = 0.248 ;
m_prop_cap = preliminary_prop_mass(MAR_010*dV_Sat_nomar,m_dry_int,Isp_int) ;
...
dV_int = MAR_080 + MAR_010*1.0158e+3 + MAR_020*1.1e+3 + MAR_100 + MAR_090;  % plus MAR-DV-010 / MAR-DV-020 / MAR-DV-080 / MAR-DV-100
Isp_int = 321;
Tmax = 440;
