function [balances] = HeatBalance_Lander_RTG(T, R,C, Q_ext , Q_diss, Clamped, TRTG)
...
Q_5RTG = R.R_6RTG*(T5^4 - TRTG^4) + C.C_6RTG*(T5- TRTG);
balances(13) = Q_50  - Q_ext(5) - Q_5int5ext;
balances(5) = + Q_51 + Q_52 + Q_53  + Q_54  + Q_56 +...
           + Q_5rad   - Q_diss(5) + Q_58 + Q_5int5ext + + Q_5RTG;
