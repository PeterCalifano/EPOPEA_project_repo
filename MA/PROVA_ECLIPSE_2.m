...
for j = 1:length(tt)
    ...
    Sat2Enc_real_IS(:,j) = R_eq_Sat*R_i_Sat*R_OM_Sat*Sat2Enc_real_EC(:,j);
    Sat2Enc_real_IS(:,j) = R_an_Sat*R_eq_Sat*R_i_Sat*R_OM_Sat*Sat2Enc_real_EC(:,j);
...
scatter3(0,0,0,50);
hold on
plot3(Sat2Enc_fake_IS(1,:),Sat2Enc_fake_IS(2,:),Sat2Enc_fake_IS(3,:),'r')   %SPICE
plot3(Sat2Enc_real_IS(1,:),Sat2Enc_real_IS(2,:),Sat2Enc_real_IS(3,:),'g--') %REAL
