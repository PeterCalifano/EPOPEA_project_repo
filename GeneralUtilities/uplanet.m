...
%               (MJD2000 = MJD-51544.5)
%   ibody       String containing name of planet for ephemeris
%                      1:   'Mercury'
%                      2:   'Venus'
%                      3:   'Earth'
%                      4:   'Mars'
...
%
% -------------------------------------------------------------------------
if strcmp(ibody,'Mercury') && ~isnumeric(ibody)

    ibody = 1;

elseif strcmp(ibody,'Venus')

    ibody = 2;

elseif strcmp(ibody,'Earth')

    ibody = 3;

elseif strcmp(ibody,'Mars')

    ibody = 4;

elseif strcmp(ibody,'Jupiter')

    ibody = 5;

elseif strcmp(ibody,'Saturn')

    ibody = 6;

elseif strcmp(ibody,'Uranus')

    ibody = 7;

elseif strcmp(ibody,'Neptune')

    ibody = 8;

elseif strcmp(ibody,'Pluto')

    ibody = 9;

elseif strcmp(ibody,'Sun')
