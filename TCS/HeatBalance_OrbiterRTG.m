function [balances] = HeatBalance_OrbiterRTG(T, R,C, Q_ext , Q_diss, Clamped, TRTG)
...
Q_64 = - Q_46;
Q_65 = - Q_56;
Q_6RTG = R.R_6RTG*(T6^4 - TRTG^4) + C.C_6RTG*(T6- TRTG);
Q_6ant = 0;
...
balances(6) = + Q_61 + Q_62 + Q_63  + Q_64  + Q_65 + Q_615 + ...
     + Q_6ant+  + Q_6rad + Q_6int6ext - Q_diss(6) + Q_6RTG;
