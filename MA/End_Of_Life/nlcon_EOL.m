function [c,ceq] = nlcon_EOL(var,mu_tbp,t_0,state0_Halo,R_Saturn,mu_v,R_v,J2_v)
% INPUTS
...
% Propagate the State until t1
[~,prop_state] = ode113(@SCR3BP_dyn,[t1 tf],x1,options_ode,mu_tbp,mu_v,R_v,J2_v);
xf = prop_state(end,:)';
